...
class PageDonnees(QWidget):
    ...
    def update_dico(self, dico):
        ...
        self.label_battery.setText(f"{dico['battery_mv']} V")
        self.label_temp.setText(f"{dico['temp_celsius']} °C")
        self.label_pressure.setText(f"{dico['pressure_hpa']} hPa")

        self.label_lat.setText(f"{dico['lat']} °")
        self.label_lon.setText(f"{dico['lon']} °")
        self.label_gps_alt.setText(f"{dico['gps_alt']} m")
        self.label_vel.setText(f"{dico['vel']} m/s")
        self.label_cog.setText(f"{dico['cog']} °")
        ...
        self.label_kalman_z.setText(f"{dico['kalman_z']} m")
        self.label_kalman_v.setText(f"{dico['kalman_v']} m/s")

        self.label_roll.setText(f"{dico['roll']} °")
        self.label_pitch.setText(f"{dico['pitch']} °")
        self.label_yaw.setText(f"{dico['yaw']} °")

        self.label_imu_acc_x.setText(f"{dico['imu_acc_x']} m/s²")
        self.label_imu_acc_y.setText(f"{dico['imu_acc_y']} m/s²")
        self.label_imu_acc_z.setText(f"{dico['imu_acc_z']} m/s²")
        self.label_imu_acc_vertical.setText(f"{dico['imu_acc_vertical']} m/s²")
        self.label_imu_gyro_x.setText(f"{dico['imu_gyro_x']} °/s")
        self.label_imu_gyro_y.setText(f"{dico['imu_gyro_y']} °/s")
        self.label_imu_gyro_z.setText(f"{dico['imu_gyro_z']} °/s")
        self.label_imu_mag_x.setText(f"{dico['imu_mag_x']} µT")
        self.label_imu_mag_y.setText(f"{dico['imu_mag_y']} µT")
        self.label_imu_mag_z.setText(f"{dico['imu_mag_z']} µT")

        self.label_highg_acc_x.setText(f"{dico['highg_acc_x']} m/s²")
        self.label_highg_acc_y.setText(f"{dico['highg_acc_y']} m/s²")
        self.label_highg_acc_z.setText(f"{dico['highg_acc_z']} m/s²")
        self.label_highg_acc_vertical.setText(f"{dico['highg_acc_vertical']} m/s²")
